...
class ArtworksControllerTest < ActionController::TestCase
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post :create, artwork: { art: @artwork.art, artist: @artwork.artist, description: @artwork.description, price: @artwork.price, title: @artwork.title, type: @artwork.type }
    end
  ...
  test "should update artwork" do
    patch :update, id: @artwork, artwork: { art: @artwork.art, artist: @artwork.artist, description: @artwork.description, price: @artwork.price, title: @artwork.title, type: @artwork.type }
    assert_redirected_to artwork_path(assigns(:artwork))
  end
